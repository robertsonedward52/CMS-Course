                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="posts.php?source=post-new"> Add New</a>
                                    <a class="nav-link" href="categories.php"> Categories</a>
                                    <a class="nav-link" href="posts.php?source=all-posts"> Posts</a>
                            ...
                            <a class="nav-link" href="comments.php?source=all-comments">
                            ...
                            <div class="collapse" id="collapseLayout" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="users.php?source=add-users"> Add New </a>
                                    <a class="nav-link" href="users.php?source=all-users"> Users</a>
                                </nav>
                            </div>
